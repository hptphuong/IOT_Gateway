...
public class ConfigurableExample implements ConfigurableComponent {
    ...
    protected void activate(ComponentContext componentContext) {
        s_logger.info("Third TIme      Bundle configurable " + APP_ID + ">>>>>>>>>>>>> has started!");
    }

    protected void activate(ComponentContext componentContext, Map<String, Object> properties) {
        s_logger.info("Third TIme      Bundle configurable" + APP_ID + " >>>>>>>>>>>>>has started>>>> with config!");
        updated(properties);
    }

    protected void deactivate(ComponentContext componentContext) {
        s_logger.info("Third TIme      Bundle configurable" + APP_ID + " >>>>>>>>>>>>>has stopped!");
    }
